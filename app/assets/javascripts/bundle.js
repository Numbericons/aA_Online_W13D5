...
"use strict";
__webpack_require__.r(__webpack_exports__);
var thunk = function thunk(state) {
...
/* harmony import */ var _actions_pokemon_actions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./actions/pokemon_actions.js */ "./frontend/actions/pokemon_actions.js");
...
/* harmony import */ var _reducers_pokemon_reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reducers/pokemon_reducer */ "./frontend/reducers/pokemon_reducer.js");
...
var Root = function Root() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "root - hello!");
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.dispatch = store.dispatch; // ReactDom.render(< Root />, root)
  // const getSuccess = pokemon => console.log(pokemonReducer({},receiveAllPokemon(pokemon)));
  // fetchAllPokemon().then(getSuccess);
  // debugger

  console.log(store.getState());
  dispatch(Object(_actions_pokemon_actions_js__WEBPACK_IMPORTED_MODULE_2__["requestAllPokemon"])());
  debugger;
...
window.receiveAllPokemon = _actions_pokemon_actions_js__WEBPACK_IMPORTED_MODULE_2__["receiveAllPokemon"];
